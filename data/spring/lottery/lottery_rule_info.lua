...
Note: Please make sure your phone's operating system supports widgets.]]
    },
    [2] = {
      picture_name = "105.png",
      title = "MLQC Widget",
...
Note: To add MLQC widgets on Andriod, please refer to Andriod widget instructions.]]
    },
    [3] = {
      picture_name = "106.png",
      title = "MLQC Widget",
...
Obtaining the all-new SSR [Gavin: Heart of Clearness] at the Wish Tree will also award you with a [c][C74848]Journal Sticker[-][/c].]]
  ...
  [1504901] = {
    [1] = {
      ...
      rule_desc = [[
Enjoy new [c][C74848]Limited-time Kiro SSR Karmas[-][/c] at the Gem Wish Tree during the event!

Kiro's SSR/SP guaranteed at the Wish Tree.
The base chance of obtaining Kiro's SSR/SP Karma is [c][C74848]1%[-][/c], and the overall chance is [c][C74848]1.93%[-][/c] (guarantee included).

If the first SSR/SP Karma received was not [Kiro: Youth for the Win], then the next SSR/SP Karma received [c][C74848]will guaranteed to be [Kiro: Youth for the Win][-][/c] (this only applies when you have not yet received [Kiro: Youth for the Win]).
...
*The Wish counter and rules for acquiring Karma for the [Dreamland Adventures] event will carry over to [Time in the Sun] event.
*This rule also applies to rerun events featuring the same character and event type.]]
    },
    [3] = {
      picture_name = "rule3.png",
      ...
      rule_desc = [[
During the event, when your wishes reach a certain amount at the Wish Tree, you can claim a corresponding reward in the [c][C74848]Wish List[-][/c]!
Making [c][C74848]72[-][/c] wishes will unlock a [c][C74848]Kiro exclusive outfit[-][/c] that can be used at Go See Him.]]
    }
  },
  [1504902] = {
    [1] = {
      ...
      title = "Activeness Event",
      rule_desc = [[
During the event, you can enter the [c][C74848][Time in the Sun][-][/c] event from the Wish Tree or through the portal on the right side of the main screen.
...
Obtaining the all-new Kiro SSR Karma at the Wish Tree will also award you with a [c][C74848]Journal Sticker[-][/c].]]
    }
  },
  [15050] = {
    [1] = {
...
If the first SSR/SP Karma received was not [Kiro: Sonorous World], then the next SSR/SP Karma received [c][C74848]will guaranteed to be [Kiro: Sonorous World][-][/c] (this only applies when you have not yet received [Kiro: Sonorous World]).
...
*The Wish counter and rules for acquiring Karma for the [Joy Everlasting] event will carry over to the [When the Sun Shines Bright] event.
*This rule also applies to rerun events featuring the same character and event type.]]
    },
    [3] = {
      picture_name = "103.png",
...
Making [c][C74848]72[-][/c] wishes will unlock a [c][C74848]Kiro exclusive outfit[-][/c] that can be used at Go See Him.]]
  ...
  [1505302] = {
    [1] = {
      ...
      title = "Activeness Event",
      rule_desc = [[
During the event, you can enter the [c][C74848][Joy Everlasting][-][/c] event from the Wish Tree or through the portal on the right side of the main screen.

During the event, a new [c][C74848]his daily practice sheet[-][/c] will be unlocked every 24 hours. Practicing with him each time rewards you with a corresponding [c][C74848]chibi character Journal Sticker[-][/c]. A total of seven stickers can be collected throughout the event.
...
Obtaining the all-new Kiro SSR Karma at the Wish Tree will also award you with a [c][C74848]Journal Sticker[-][/c].]]
    ...
    [2] = {
      ...
      title = "Activeness Event",
      rule_desc = [[
This event features two pages of sheet music, which you can navigate using the button located in the bottom right corner of the screen. Once you complete your practice, a heartwarming story will also be unlocked for you to enjoy.

When a new sheet becomes available, you'll need to finish the previous one to unlock it.
To revisit his practice performance, tap the suona icon beside the sheet music. To relive the moments you practiced together, simply tap on the sheet itself.
...
After watching the story at the end of a practice, tap the [Practice is over for today.] button to return to the main event screen.]]
    }
  },
  [1505401] = {
    [1] = {
...
During the event, [c][C74848]limited-time UR Karmas[-][/c] will be available at the Gem Wish Tree!]]
    }
  },
  [1507301] = {
    [1] = {
